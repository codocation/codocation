---
title: Codocation - Professional docs-as-code (IntelliJ plugin & standalone app)
seo-description: Author Markdown documentation with live preview and a visual navigation editor. Codocation validates your docs as you write and blocks a build that would ship broken links or bad configuration. Build a static site or a PDF from the same project. JetBrains IDE plugin or standalone app.
layout: full
---

:::hero {badge="IntelliJ plugin · Standalone app" heading="Documentation that can't ship broken"}
...
Codocation is a docs-as-code authoring tool. Your documentation is plain files in Git: pages are written in
Markdown, and navigation and configuration are defined in YAML. Codocation adds a live preview, a
visual navigation tree, and validation that catches broken pages before they are published. The project builds into a static site or a PDF, or deploys to GitHub
Pages or Cloudflare Pages in one click. Codocation runs as a JetBrains IDE plugin or a standalone app, and both open the
same project.
